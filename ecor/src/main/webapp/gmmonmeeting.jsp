					...
					<tr>
						<td>
							<ul class="reportul">
								...
								<li><a href="gminspection.jsp" target="_blank">GM Inspection Report</a></li>
								<li><a href="jpo.jsp" target="_blank">Joint Procedure Orders(JPO) Of Departments</a> </li>
