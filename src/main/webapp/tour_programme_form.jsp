	       ...
	       <TR class="success">
				...
				<div class="form-group has-success">
                   <label>Officer's Name:</label>
                     <input name="officer_name" id="officer_name" type="text" class="form-control" autofocus required />                                              
                </div>
				</TD>
	       		<TD>			
				<div class="form-group has-success">
	       ...
	       <TR class="success">
				...
				<div class="form-group has-success">
                   <label>Leaving HQ on:</label>                    
                     <input name="hq_leaving" type="datetime-local" class="form-control" required />                                              
                </div>
				</TD>
				...
				<div class="form-group has-success">
                   <label>Coming Back on:</label>
                     <input name="hq_return" type="datetime-local" class="form-control" required />                            
                </div>
				</TD>
				</TR>
	       <TR class="success">			 			 
				...
				<div class="form-group has-success">
                   <label>Purpose:</label>                     
                     <textarea name="tour_purpose" class="form-control" placeholder="Enter Purpose" required ></textarea>                                              
                </div>
				</TD>		        							 			 
	       </TR>
	       <TR class="success">
				<TD>			
				 <div class="form-group has-success">
				   ...
				   <input name="tour_location" type="text"  class="form-control" placeholder="Enter Location" required />
                  </div>
				</TD>
				<TD>			
				 <div class="form-group has-success">
